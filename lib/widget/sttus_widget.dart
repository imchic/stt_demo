                  ...
                  child: CustomScrollView(
                    ...
                    slivers: [
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  CustomRichText(
                                      length: controller.ladSttusInqireDataSource
                                          .value.rows.length),
                                  Row(
                                    children: [
                                      CustomChip(
                      ...
                      SliverFillRemaining(
                        fillOverscroll: true,
                        child:
                            controller.ladSttusInqireDataSource.value.rows.isEmpty
                                ? Container(
                ...
                Padding(
                  ...
                  child: CustomScrollView(
                      ...
                      slivers: [
                        ...
                        SliverFillRemaining(
                          fillOverscroll: true,
                          child: controller.obstSttusInqireDataSource.value.rows.isEmpty ?
                          SizedBox(
                            width: double.infinity,
                            child: Center(
                              child: AutoSizeText('데이터가 없습니다.',
